...
function validateGuess(guess){
    if (isNaN(guess)){
        ...
        alert('Please ener a number less than 100!')
    } else {
        //Keep record number of attempted guesses
        ...
        if (numGuesses === 5){
            ...
            //Display previous guessed numbers with spacing 1.5
            displayGuesses(guess+",");
            //Check guess and displaay if wrong 
            checkGuess(guess);
        }
    }
}
